...
public class TrocaOleoActivity extends AppCompatActivity {
    ...
    public void gravarTrocaOleo() {
        ...
        try {
            ...
            if (txtKmTrocaOleo.getText().toString().equals("") || txtKmProximaTroca.getText().toString().equals("")) {
                ...
                Toast.makeText(getBaseContext(), "Troca de óleo registrado", Toast.LENGTH_LONG).show();

            }

        } catch (Exception ex) {
            Toast.makeText(getBaseContext(), "Erro no registro de troca de óleo", Toast.LENGTH_LONG).show();
        }
